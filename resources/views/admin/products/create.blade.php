                    ...
                    <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" required
                                class="w-full bg-slate-50 border-slate-200 rounded-2xl p-4 focus:ring-blue-600 focus:border-blue-600"
                                placeholder="Cth: Casing iPhone 15 Pro Max">
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">Harga
                                    (Rp)</label>
                                <input type="number" name="price" required
                                    class="w-full bg-slate-50 border-slate-200 rounded-2xl p-4" placeholder="50000">
                            </div>
                            <div>
                                <label
                                    class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">Stok</label>
                                <input type="number" name="stock" required
                                    class="w-full bg-slate-50 border-slate-200 rounded-2xl p-4" placeholder="10">
                            </div>
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">Varian
                                (Pisahkan dengan koma)</label>
                            <input type="text" name="variants"
                                class="w-full bg-slate-50 border-slate-200 rounded-2xl p-4"
                                placeholder="iPhone 11, iPhone 12, iPhone 13">
                            <p class="text-[10px] text-slate-400 mt-1 italic">*Kosongkan jika produk universal (seperti
                                Powerbank)</p>
                        </div>

                        <div>
                            <label
                                class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">Deskripsi</label>
                            <textarea name="description" rows="4" class="w-full bg-slate-50 border-slate-200 rounded-2xl p-4"></textarea>
                        </div>

                        <button type="submit"
                            class="w-full bg-slate-900 text-white font-bold py-4 rounded-2xl hover:bg-blue-600 transition-all shadow-lg shadow-slate-200">
                            Simpan Produk
                        </button>
                    </div>
                </div>
